...
type verseType = {[key: string]: any};
export const verses: verseType = {
  1: {
    verse: ["Éxodo 32:2-6"],
    text: [`2 Aarón les respondió:
  ...
  6: {
    ...
    Entonces todos los israelitas apedrearon a Acán y a los suyos, y los quemaron. 26 Luego colocaron sobre ellos un gran montón de piedras que sigue en pie hasta el día de hoy. Por eso aquel lugar se llama valle de Acor.[b] Así aplacó el Señor el ardor de su ira.`]
  },
  7: {
    verse: ["Jueces 19-21"],
    text: [`El levita y su concubina
    19 En la época en que no había rey en Israel, un levita que vivía en una zona remota de la región montañosa de Efraín tomó como concubina a una mujer de Belén de Judá. 2 Pero ella le fue infiel y lo dejó, volviéndose a la casa de su padre, en Belén de Judá. Había estado allí cuatro meses 3 cuando su esposo fue a verla para convencerla de que regresara. Con él llevó a un criado suyo y dos asnos. Ella lo hizo pasar a la casa de su propio padre, quien se alegró mucho de verlo. 4 Su suegro, padre de la muchacha, lo convenció de que se quedara, y él se quedó con él tres días, comiendo, bebiendo y durmiendo allí.
    ...
    2 El pueblo fue a Betel,[d] y allí permanecieron hasta el anochecer, clamando y llorando amargamente en presencia de Dios. 3 «Oh Señor, Dios de Israel —clamaban—, ¿por qué le ha sucedido esto a Israel? ¡Hoy ha desaparecido una de nuestras tribus!»
  ...
  8: {
    ...
    text: [`11 »Pues bien, así dice el Señor: “Yo haré que el desastre que mereces surja de tu propia familia, y ante tus propios ojos tomaré a tus mujeres y se las daré a otro, el cual se acostará con ellas en pleno día. 12 Lo que tú hiciste a escondidas, yo lo haré a plena luz, a la vista de todo Israel”».`]
  },
  9: {
    ...
    —¿Cómo estás, Zimri, asesino de tu señor?[a]
    
    32 Levantando la vista hacia la ventana, Jehú gritó:
    
    —¿Quién está de mi parte? ¿Quién?
    
    Entonces se asomaron dos o tres oficiales,[b] 33 y Jehú les ordenó:
    ...
    35 Pero, cuando fueron a enterrarla, no encontraron más que el cráneo, los pies y las manos. 36 Así que volvieron para informarle a Jehú, y este comentó:
    
    —Se ha cumplido la palabra que el Señor dio a conocer por medio de su siervo Elías el tisbita, que dijo: “En el campo de Jezrel los perros se comerán a Jezabel”.[c] 37 De hecho, el cadáver de Jezabel será como estiércol en el campo de Jezrel, y nadie podrá identificarla ni decir: “Esta era Jezabel”.`]
  },
}